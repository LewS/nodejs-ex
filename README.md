...
Now let's pull in the app source code from [GitHub repo](https://github.com/LewS/nodejs-poc) (fork if you like).

#### create ####

        $ oc new-app https://github.com/LewS/nodejs-poc -l name=myapp
